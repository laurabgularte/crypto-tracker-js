...
- [JavaScript (ES6+)](https://developer.mozilla.org/pt-BR/docs/Web/JavaScript) - Lógica da aplicação e consumo de API.
- [HTML5](https://developer.mozilla.org/pt-BR/docs/Web/HTML) - Estruturação dos elementos.
- [CSS3](https://developer.mozilla.org/pt-BR/docs/Web/CSS) - Estilização e layouts (Flexbox/Grid).
- [Fetch API](https://developer.mozilla.org/pt-BR/docs/Web/API/Fetch_API) - Para requisições assíncronas de dados.
